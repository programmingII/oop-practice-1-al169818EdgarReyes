...
class Excercise27{	//Declaration of a class named Excerise7
	public static void main(String[] args){
		...
		String res = Integer.toHexString(oct);			//Initialization of the String type variable res which value is the variable
