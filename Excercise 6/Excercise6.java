...
class Excercise6{ //Declaration of a class named Excercise6
	public static void main(String[] args){ //Declaration of the main function. Public it's an access specifier that means that you can 
		...
		System.out.println("Addition : " + (x + y));	//Prints the text addition followed by the addition of x and y. + is used for
								//concatenation.
		
		System.out.println("Multiplication: " + (x * y)); //Prints the text Multiplication followed by the Product of x and y. + is used for
								//concatenation.
		
		System.out.println("Substraction: " + (x - y)); //Prints the text Substraction followed by the substractionn of x and y. + is used for
								//concatenation.
		
		System.out.println("Division: " + (x / y)); 	//Prints the text division followed by the division of x and y. + is used for
								//concatenation.
		
		System.out.println("Remainder: " + (x % y)); 	//Prints the text remainder followed by the remainder of x and y. + is used for
								//concatenation.
