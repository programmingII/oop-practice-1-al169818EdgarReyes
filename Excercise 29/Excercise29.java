// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/18/19		Hora: 9:03

import java.util.Scanner; //On this line I include the external class Scanner.

class Excercise29{	//Declaration of a class named Excerise7
	public static void main(String[] args){
		...
		String res = Integer.toBinaryString(hex);			//Initialization of the String type variable res which value is the variable
										//oct represented as an hexadecimal string, this was made using the toHexString method
										// of the Integer class.
		
		System.out.println("Binary number: " + res);	//Prints the convertion.
	}
