...
class Excercise44{	//Declaration of a class named Excercise44
	...
	public static void main(String[] args){ //Declaration of the main function. Public it's an access specifier that means that you can 
		...
		System.out.println("Input number: "); //Asks for a number. System it's a class. Out it's a field on the system class, 
		...
		int num = input.nextInt(); //Initialization of the int variable num which value is the scan of the next 
