// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/17/19		Hora: 11:43
...
class Excercise55{	//Declaration of a class named Excercise55
	...
	Scanner input = new Scanner(System.in); // Declaration of an object named input of the class Scanner. Then with the new 
		...
		System.out.println("Input seconds: "); //Asks for a number of seconds. System it's a class. Out it's a field on the system class, 
		...
		int sec = input.nextInt(); //Initialization of the variable sec which value is the scan of the next 
