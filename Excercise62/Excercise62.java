// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/27/19		Hora: 08:17
...
class Excercise62{	//Declaration of a class named Excercise62
	...
	Scanner input = new Scanner(System.in); // Declaration of an object named input of the class Scanner. Then with the new 
		...
		if(Math.abs(n1 - n2) >= 20 || Math.abs(n2 - n3) >= 20 || Math.abs(n3 - n1) >= 20)
