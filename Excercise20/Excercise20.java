// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/17/19		Hora: 7:09

import java.util.Scanner; //On this line I include the external class Scanner.

class Excercise20{	//Declaration of a class named Excercise20
	public static void main(String[] args){
		...
		String res = Integer.toHexString(dec);			//Initialization of the String type variable res which value is the variable
										//dec represented as a hex string, this was made using the toHexString method
										// of the Integer class.
		
		System.out.println("Hexadecimal number: " + res);	//Prints the result of the convertion.
	}
}
