// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/17/19		Hora: 6:50

import java.util.Scanner; //On this line I include the external class Scanner.

class Excercise18{	//Declaration of a class named Excercise18
	public static void main(String[] args){
		...
		int add = Integer.parseInt(bin1, 2) * Integer.parseInt(bin2, 2); //Initialization of the int type variable add which value is the product of 
