// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/17/19		Hora: 01:01
...
class Excercise57{	//Declaration of a class named Excercise57
	...
	Scanner input = new Scanner(System.in); // Declaration of an object named input of the class Scanner. Then with the new 
		...
		System.out.println("Input an integer: "); //Asks for a number. System it's a class. Out it's a field on the system class, 
