// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/18/19		Hora: 5:45

import java.util.Scanner; //On this line I include the external class Scanner.

class Excercise24{	//Declaration of a class named Excerise7
	public static void main(String[] args){
		...
		int oct = Integer.parseInt(bin1, 2); 				//Initialization of the int type variable oct which value is the binary
		...
		String res = Integer.toOctalString(oct);			//Initialization of the String type variable res which value is the variable
										//add represented as a string, this was made using the toBinaryString method
										// of the Integer class.
		
		System.out.println("Octal number: " + res);	//Prints the convertion.
	}
