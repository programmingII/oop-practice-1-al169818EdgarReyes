// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/17/19		Hora: 12:33
...
class Excercise56{	//Declaration of a class named Excercise56
	...
	Scanner input = new Scanner(System.in); // Declaration of an object named input of the class Scanner. Then with the new 
		...
		System.out.println("Input first range: "); //Asks for a number of seconds. System it's a class. Out it's a field on the system class, 
		...
		System.out.println("Input second range: ");
