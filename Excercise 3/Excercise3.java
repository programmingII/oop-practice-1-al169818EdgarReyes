//Nombre: Edgar Omar Reyes Olivas 		Dia: 02/05/19		Hora: 12:47

class Excercise3{ //Declaration of a class named Excercise3
	public static void main(String[] args){ //Declaration of the main function. Public it's an access specifier that means that you can 
		...
		System.out.println(50/3); 	//Printing the division between two numbers. System it's a class. Out it's a field on the system class, 
