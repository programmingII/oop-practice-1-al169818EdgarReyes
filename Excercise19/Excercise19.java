// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/17/19		Hora: 6:52

import java.util.Scanner; //On this line I include the external class Scanner.

class Excercise19{	//Declaration of a class named Excercise19
	public static void main(String[] args){
		...
		String res = Integer.toBinaryString(dec);			//Initialization of the String type variable res which value is the variable
										//dec represented as a binary string, this was made using the toBinaryString method
										// of the Integer class.
		
		System.out.println("Binary number: " + res);	//Prints the result of the convertion.
	}
}
