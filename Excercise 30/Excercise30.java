// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/18/19		Hora: 9:04

import java.util.Scanner; //On this line I include the external class Scanner.

class Excercise30{	//Declaration of a class named Excercise7
	public static void main(String[] args){
		...
		String res = Integer.toOctalString(hex);			//Initialization of the String type variable res which value is the variable
										//hex represented as an octal string, this was made using the toOctalString method
