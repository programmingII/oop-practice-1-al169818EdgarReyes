// Nombre: Edgar Omar Reyes Olivas		Fecha: 02/18/19		Hora: 8:50

import java.util.Scanner; //On this line I include the external class Scanner.

class Excercise25{	//Declaration of a class named Excerise7
	public static void main(String[] args){
		...
		String res = Integer.toString(oct);				//Initialization of the String type variable res which value is the variable
										//oct represented as a string, this was made using the toString method
