...
class Excercise22{	//Declaration of a class named Excerise7
	public static void main(String[] args){
		...
		int dec = Integer.parseInt(bin1, 2); 				//Initialization of the int type variable dec which value is the binary
		...
		System.out.println("Decimal number: " + dec);	//Prints the result of the addition of two binary numbers.
	}
