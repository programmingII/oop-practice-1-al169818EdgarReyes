...
class Excercise35{	//Declaration of a class named Excercise35
	...
	System.out.println("Input the number of sides of the polygon: "); //Asks for numbers of sides of hte polygon. System it's a class. Out it's a field on the system class, 
	...
	System.out.println("Input the length of a side of the polygon: "); //Asks for the lenght of a side of a polygon. System it's a class. Out it's a field on the system class, 
	...
	double area = (num * (side*side))/(4*Math.tan(Math.PI/num));		//Initialization of the variable area. Math.tan is a method from the class Math that 
								       //returns the trigonometric tangent of an angle. Math.PI is a field from the Math class.
	
	System.out.println("The area of the polygon is: " + area);	//Prints the result.
